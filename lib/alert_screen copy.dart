...
class _AlertScreenState extends State<AlertScreen> {
  ...
  Future<void> _playAlertSound() async {
    ...
    try {
      ...
      // Device media is stored in Supabase.  Its public URL must be used
      // directly; rewriting it to the Laravel /storage path returns a web
      // page instead of audio and the browser rejects it as an invalid format.
