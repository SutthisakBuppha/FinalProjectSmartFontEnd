...
class _ProfileEditScreenState extends State<ProfileEditScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: AppText('อัปเดตข้อมูลสำเร็จเรียบร้อย')),
        );
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: AppText('บันทึกข้อมูลล้มเหลว: $e')));
    }
  }
      ...
      child: Column(
        children: [
          ...
          AppText(
            ...
            style: GoogleFonts.prompt(color: AppColors.textMuted, fontSize: 13),
          ),
        ],
      ),
    );
  ...
  Future<void> _showAvatarSourceSheet() async {
        ...
        child: Wrap(
          children: [
            ListTile(
              ...
              title: const AppText('เลือกรูปจากคลังภาพ'),
              onTap: () => Navigator.pop(sheetContext, false),
            ),
            ListTile(
              leading: const Icon(Icons.camera_alt_outlined),
              title: const AppText('ถ่ายรูปใหม่'),
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: AppText('อัปโหลดรูปภาพไม่สำเร็จ: $error')),
        );
      }
    } finally {
